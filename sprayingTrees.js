...
//  for (let i = 0; i < names.length; i++)
  if (w == "Monday"){
  return `It is ${w} today, ${names[0]}, you have to work, you must spray ${n} trees and you need ${x} dollars to buy liquid`
   } else if (w == 'Tuesday'){
   return `It is ${w} today, ${names[1]}, you have to work, you must spray ${n} trees and you need ${x} dollars to buy liquid`
    } else if (w == 'Wednesday'){
      return `It is ${w} today, ${names[2]}, you have to work, you must spray ${n} trees and you need ${x} dollars to buy liquid`
    } else if (w == 'Thursday'){
        return `It is ${w} today, ${names[3]}, you have to work, you must spray ${n} trees and you need ${x} dollars to buy liquid`
    } else if (w == 'Friday'){
        return `It is ${w} today, ${names[4]}, you have to work, you must spray ${n} trees and you need ${x} dollars to buy liquid`
    }
